...
import Steam from '../../Asset/steam.gif';
import pizzabg from '../../Asset/pizza.webp';
        ...
        <>
            <div className="Promotion-container">
                <div className="Promotion-content">
                    <div className="tagline">Fastes <b> Delivery </b>In A Town.</div><br />
                    <div className="promotion-description">Get Your Dream Order Fresh, Steamed Hot at 20min Break Time.</div>
                </div>
                <div className="Promotion-content width">
                    <img src={Steam} alt="" />
                    <img className="fix" src={pizzabg} alt="" />
                </div>
                <div className="Promotion-content">
                    <div className="promotion-point-row">
                        <div className="svg-container">
                            <AiOutlineFieldTime />
                        </div>
                        <div className="promotion-point">Get Faster</div>
                    </div>
                    <div className="promotion-point-description">Offer fast delivery times and real-time tracking of orders.</div>
                    <div className="promotion-point-row">
                        <div className="svg-container">
                            <GoPackage />
                        </div>
                        <div className="promotion-point ">Pakaging</div>
                    </div>
                    <div className="promotion-point-description">Ensure food is properly packaged and delivered in a timely manner.</div>
                    <div className="promotion-point-row">
                        <div className="svg-container">
                            <GiFruitBowl />
                        </div>
                        <div className="promotion-point">Quality</div>
                    </div>
                    <div className="promotion-point-description">Maintain high standards of food quality, safety, and hygiene.</div>
